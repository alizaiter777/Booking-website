...
<body>
  <section class="section stepper__wrapper">
    ...
    <div class="stepper__content" aria-live="polite">
      ...
      <div id="step1-panel" class="step__content active" role="tabpanel" aria-labelledby="step1-tab">Biking</div>
      <div id="step2-panel" class="step__content" role="tabpanel" aria-labelledby="step2-tab">Hiking</div>
      <div id="step3-panel" class="step__content" role="tabpanel" aria-labelledby="step3-tab">Running</div>
